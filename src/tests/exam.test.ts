...
describe('Exam utilities', () => {
  ...
  test('includes the reviewed vehicle and operational questions with corrected answers', () => {
    const expectedAnswers: Record<string, string> = {
      ...
      'vehicle-spec-03': '5 minutes',
      'vehicle-spec-04': 'Approximately 300 miles using 154 gallons',
      'vehicle-spec-05': 'Fuel quantity is below approximately one-eighth of a full tank',
      'vehicle-spec-06': 'Remove water from the fuel before it reaches the engine',
      'vehicle-spec-07': 'Store, cool, and filter oil used by the hydraulic and power-steering systems',
      'vehicle-spec-08': 'Inter-axle, center/off, and 8x8',
